...
.tblhead tr td {
 ...
 <style type="text/css">
        /* Layout */
        #gridarea { display: flex; overflow: auto; background: rgba(136,153,119,0.23); height: 400px; padding: 2px; }
        .fullpad div { padding-left: 0; padding-right: 0; }

        /* Tables */
        #tbl_est_data tbody tr td, #tbl_po_data tbody tr td, #tbl_po_data2 tbody tr td { padding: 13px; }
        #tbl_po_data2 tbody tr td{ padding: 5px !important; border-bottom:1px solid #fff !important; }

        /* Small helper classes */
        .editrowClass { background-color: #f1b9b9; }

        /* Print area sizes */
        #printArea { margin:5px; }
        #printAreaPos { margin:0px; }

        /* Inline small adjustments used in POS section */
        @media print {
            /* You can add print-specific styles here if needed */
        }
    </style>
    ...
    <div class="box-header" style="background: #b4f3c8">
        ...
        <div class="col-sm-8">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button type="button" id="btnPrintPos" class="btn btn-sm btn-block"
                        style="background:#2a2a2a;color:#fff;border-color:#2a2a2a;">
                        Print Pos
                    </button>
                </div>
                ...
                <div class="col-sm-2"><?php if($invHed->IsCancel==0 && $invHed->IsPayment==1){?>
                    <button disabled="disabled" type="button" <?php echo $disabled;?> id="btnCancel"
                        class="btn btn-danger btn-sm btn-block">Invoice Cancel</button>
                    <?php } else { ?> <button type="button" <?php echo $disabled;?> id="btnCancel"
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <div class="row" id="printArea" align="center" style='margin:5px;'>
                    ...
                    <table style="border-collapse:collapse;width:590px;font-family: Arial, Helvetica, sans-serif;"
                        ...
                        <tr style="text-align:left;font-size:13px;">
                            ...
                            <td colspan="4" style="font-size:18px;font-weight: bold;text-align:right; "> JOB INVOICE
                            </td>
                        </tr>
                        <tr style="text-align:left;font-size:13px;">
                            <td colspan="2" rowspan="5"
                                ...
                                <span>
                                    <?php if ($invCus->DisType!=4){ ?>
                                    <?php echo nl2br($invCus->Address01)."<br>".$invCus->Address02;?>
                        ...
                        <tr style="text-align:left;font-size:12px;">
                            ...
                            <td colspan="2"
                                style="font-size:11px;text-align:right;border-right: 1px solid #000;border-bottom: 1px solid #000;">
                                <?php  echo $invHed->first_name." ".$invHed->last_name[0];?>&nbsp;&nbsp;</td>
                        </tr>
              ...
              $noofjob=0;$refno=0;$nextService=0;
                    ...
                    <table class="tblhead"
                        style="margin-top:3px;font-size:12px;border-collapse:collapse;width:590px;font-family: Arial, Helvetica, sans-serif;">
                        <!--  <tr style=" border: 1px solid black;">-->
                        <!--    <td  style="border: 1px solid black;width: 150px;">REG. NO. <br> &nbsp;&nbsp; <span style="text-align: center;font-size:11px;">--><?php //echo $invHed->regNo;?>
                        <!--</span></td>-->
                        ...
                        <!--  </tr>-->
                        <!--  <tr style=" border: 1px solid black;">-->
                        <!--    <td  style="border: 1px solid black;width: 150px;">MILEAGE OUT<br> &nbsp;&nbsp; <span style="text-align: center;font-size:11px;">--><?php //if($invjob){echo ml_to_km($invjob->OdoOut,$invjob->OdoOutUnit);}?>
                        <!-- KM</span></td>-->
                        <!--    <td  style="border: 1px solid black;width: 150px;">LAST SERVICE DATE. <br> &nbsp;&nbsp;<span style="text-align: center;font-size:11px;">--><?php //if(isset($invjob)){ echo $last_job;}?>
                        <!--</span></td>-->
                        <!--    <td  style="border: 1px solid black;width: 150px;">NEXT SERVICE <br> &nbsp;&nbsp;<span style="text-align: center;font-size:11px;">--><?php //if(isset($invjob)){ echo nextodo($invjob->OdoOut,$invjob->OdoOutUnit,$invjob->NextService);} ?>
                        <!-- KM</span></td>-->
                        <!--    <td  style="border: 1px solid black;width: 150px;">JOB NO. <br> &nbsp;&nbsp;<span style="text-align: center;font-size:11px;">--><?php //echo $invHed->jobcardNo ?>
                        <!--</span></td>-->
                        <!--  </tr>-->
                        <?php 
...
return $km;
 ...
 <style>
    #tbl_est_data td,
    #tbl_est_data th {
        padding: 2px 4px !important; /* reduce top/bottom padding */
        line-height: 12px !important; /* reduce row height */
    }
</style>
                    ...
                    <table id="tbl_est_data"
                        style="font-family: Arial, Helvetica, sans-serif;border-collapse:collapse;width:590px;padding:5px;font-size:13px; "
                        align="center" border="0">
                        <tbody>
                            <tr style="line-height: 5px;background-color:#5d5858 !important;">
                          ...
                          // var_dump($invDtl);die;
                                 ...
                                 // if($key!='PARTS2'){ ?>
                            <tr style="background-color:#e4dbdb !important;color:#000 !important;">
                                <td style=""></td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="border-bottom:1px dotted #e4dbdb;">
                                    <?php echo $inv->JobDescription?> <br> <?php echo $inv->SalesSerialNo ?></td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th id="totalAmount" style='text-align:right;padding-right:5px;'>
                            ...
                            <tr>
                                ...
                                <th style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid;'>
                                    DISCOUNT &nbsp;&nbsp;</th>
                                <th style="border-right: 1px solid #fff;">Rs.</th>
                                <th id="totalDiscount" style='text-align:right;padding-right:5px;'><span
                            ...
                            <tr>
                                ...
                                <th style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid;'>
                                    ADVANCE &nbsp;&nbsp;</th>
                                <th style="border-right: 1px solid #fff;">Rs.</th>
                                <th id="totalAdvance" style='text-align:right;padding-right:5px;'>
                            ...
                            <tr>
                                ...
                                <th style='text-align:right;border-left:1px #fff solid;border-bottom:1px #fff solid;'>
                                    TOTAL &nbsp;&nbsp;</th>
                                <th style="border-right: 1px solid #fff;">Rs.</th>
                                <th id="netAmount" style='text-align:right;padding-right:5px;'>
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="border-top:1px dashed #000;text-align: center;width:150px;">Issued By</td>
                                <td style="width: 50px;">&nbsp;</td>
                                <td style="border-top:1px dashed #000;text-align: center;width:150px;">Checked by</td>
                                <td style="width:50px;">&nbsp;</td>
                                <td colspan="2"
                                    style="border-top:1px dashed #000;text-align: center;font-size: 10px;width:150px;">
                            ...
                            <tr>
                                <td colspan="7" style="padding: 2px;">&nbsp;<?php echo nl2br($invHed->InvRemark); ?>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7" style="padding: 2px;"><span>Terms & Conditions</span>
                                    <ul>
                                        <?php if($jobtype->JPayType==2){?>
                                        <li>Any complaints are kindly requested to be made within 15 days of job closing
                                        </li>
                                        <li>Used parts and electrical items returns not accepted unless approved at
                                            point of sale by management</li>
            ...
            <div class="col-lg-1">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a
                                    href="<?php echo base_url('admin/Salesinvoice/view_invoice/').base64_encode($v->JobInvNo); ?>"><?php echo $v->JobInvNo;?></a>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
            ...
            <div class="col-lg-4">
                <table class="table">
                    <tr>
                        <td>Create by</td>
                        <td>:</td>
                        <td><?php echo $invHed->first_name." ".$invHed->last_name[0] ?></td>
                    </tr>
                    <tr>
                        <td>Create Date</td>
                        <td>:</td>
            ...
            <div>
                <div class="row" id="printAreaPos" align="center">

                 <?php $this->load->view('admin/_templates/company_header_mini.php', true); ?>

                    <table style="border-collapse:collapse;width:290px;font-family:Arial, Helvetica, sans-serif;"
                        border="0">
                        <!-- HEADER -->
                        <tr style="text-align:center;font-size:13px;">
                            <td colspan="3" style="border-bottom:1px solid #000;font-size:15px;font-weight:bold;">Job
                                Invoice</td>
                        </tr>
                        <tr>
                            <td style="font-size:13px;text-align:left;">Job InvoiceNo</td>
                            <td>:</td>
                            <td><?php echo $invHed->JobInvNo; ?></td>
                        </tr>
                        <tr>
                            <td style="font-size:13px;text-align:left;">Job No</td>
                            <td>:</td>
                            <td><?php echo $invHed->JobInvNo; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo date('Y-m-d', strtotime($invHed->date)); ?></td>
                        </tr>
                        <tr>
                            <td style="font-size:13px;text-align:left;">Customer</td>
                            <td>:</td>
                            <td><?php echo $invCus->DisplayName; ?></td>
                        </tr>

                        <!-- ITEMS HEADER -->
                        <tr style="background-color:#5d5858;color:#fff;line-height:20px;">
                        ...
                        <!-- PARTS -->
                        <?php if (!empty($invDtl['PARTS'])): ?>
                        <tr>
                            <td colspan="4" style="font-weight:bold;">PARTS</td>
                        </tr>
                        <?php foreach ($invDtl['PARTS'] as $invdata): ?>
                        <tr>
                            <td> <?php echo $invdata->JobDescription?> <br> <?php echo $invdata->SalesSerialNo ?></td>
                            <td style="text-align:center;"><?php echo number_format($invdata->JobQty, 2); ?></td>
                            <td style="text-align:right;"><?php echo number_format($invdata->JobPrice, 2); ?></td>
                            <td style="text-align:right;"><?php echo number_format($invdata->JobTotalAmount, 2); ?></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>


                        <?php if (!empty($invDtl['LABOUR'])): ?>
                        <tr>
                            <td colspan="4" style="font-weight:bold;">LABOUR</td>
                        </tr>
                        <?php foreach ($invDtl['LABOUR'] as $invdata): ?>
                        <tr>
                            <td> <?php echo $invdata->JobDescription?> <br> <?php echo $invdata->SalesSerialNo ?></td>
                            <td style="text-align:center;"><?php echo number_format($invdata->JobQty, 2); ?></td>
                            <td style="text-align:right;"><?php echo number_format($invdata->JobPrice, 2); ?></td>
                        ...
                        <tr>
                            <td colspan="3" style="text-align:left;border-top:1px solid #060404;padding:3px;">Total
                                Amount</td>
                            <td style="text-align:right;border-top:1px solid #060404;">
                                <?php echo number_format($invHed->JobTotalAmount, 2); ?></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:left;">Total Discount</td>
                            <td style="text-align:right;"><?php echo number_format($invHed->JobTotalDiscount, 2); ?>
                            </td>
                        </tr>
                        <?php if ($invHed->SalesVatAmount > 0 && $invHed->SalesInvType == 2): ?>
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align:right;">VAT: <?php echo number_format($invHed->SalesVatAmount,2); ?>
                            </td>
                        </tr>
                        <?php endif; ?>
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td style="text-align:right;">NBT: <?php echo number_format($invHed->SalesNbtAmount,2); ?>
                            </td>
                        </tr>
                        <?php endif; ?>
                        <tr>
                            ...
                            <td style="font-weight:bold;text-align:right;">
                                <?php echo number_format($invHed->JobTotalAmount-$invHed->JobTotalDiscount,2); ?></td>
                        </tr>
                        <!-- <tr>
                        <td colspan="3" style="font-weight:bold;text-align:left;">Paid Amount</td>
                        <td style="font-weight:bold;text-align:right;"><?php echo number_format($invHed->SalesCustomerPayment,2); ?></td>
                        </tr>
                        <tr>
                        <td colspan="3" style="font-weight:bold;text-align:left;">Balance</td>
                        <td style="font-weight:bold;text-align:right;"><?php echo number_format($invHed->Blance,2); ?></td>
                        </tr> -->
                    </table>
                </div>
        ...
        foreach ($inv_pay AS $invpay) { ?>
                ...
                <button id="cardPrint" <?php if($card_pay==''){  ?>disabled<?php } ?> class="btn btn-primary">Card
                    Receipt Print</button>
                &nbsp;&nbsp;&nbsp;

                <button id="chequePrint" <?php if($cheque_pay==''){?>disabled<?php } ?> class="btn btn-primary">Cheque
                    Receipt Print</button>
        ...
        <div class="modal-content">
            ...
            <tr style="text-align:center;font-size:15px;font-family: Arial, Helvetica, sans-serif;">
              ...
              $noofjob=0;$refno=0;$nextService=0;
                    ...
                    <table id="tbl_est_data"
                        style="border-collapse:collapse;width:590px;padding:5px;font-size:13px; margin-right: 220px;"
                        align="center" border="0">
                        <tbody>
                          ...
                          // var_dump($invDtl);die;
                                 foreach ($invDtl AS $key=>$invdata) {
                                 //if($key!='PARTS2'){ ?>
                            <tr style="line-height: 1px;background-color:#e4dbdb !important;color:#000 !important;">
                                <td style=""></td>
                                <td colspan="2" style=""><b><?php echo $key?></b></td>
                                <td style=""></td>
                                <td style=""></td>
