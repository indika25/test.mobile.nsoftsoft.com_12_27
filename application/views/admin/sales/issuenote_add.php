                    ...
                    <div class="row" style="background: #D0D0D0;"><br>
                        ...
                        <div class="col-md-4">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <label for="customer" class="col-sm-4 control-label">Issue Note No <span
                                            class="required">*</span></label>
                                    <div class="col-sm-7">
                                        <input type="text" tabindex="1" class="form-control" value="<?php echo $inv; ?>"
                                            name="grn_no" id="grn_no" placeholder="Auto Generate">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="grnDate" class="col-sm-4 control-label">Issue Date <span
                                            class="required">*</span></label>
                                    <div class="col-sm-7">
                                        <input type="text" tabindex="1" disabled class="form-control"
                                            required="required" name="grnDate" id="grnDate" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="po_number" class="form-control" id="po_number"
                                            placeholder="Job Number" value="<?php echo $job; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="additional" class="col-sm-4 control-label">Issue Person</label>
                                    <div class="col-sm-7">
                                        <select class="form-control" required="required" name="newsalesperson"
                                            id="newsalesperson" placeholder="sales person">
                                            <option value="">-Select a Issue person-</option>
                                            <?php foreach ($salesperson as $trns) { ?>
                                            <option value="<?php echo $trns->RepID; ?>"><?php echo $trns->RepName; ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <!--                                                <option value="--><?php //echo $trns->VComId; ?>
                                <!--" >--><?php //echo $trns->VComName; ?>
                                <!--</option>-->
                                <!--                                            --><?php //} ?>
                                <!--                                        </select>-->
                                <!--                                    </div>-->
                        ...
                        <div class="col-md-5">
                            <row class="form-horizontal">
                                <div class="form-group">
                                    <label for="supplier" class="col-sm-4 control-label">Customer<span
                                            class="required">*</span></label>
                                    <div class="col-sm-7">
                                        <div class="input-group">
                                            <input type="text" tabindex="1" class="form-control" required="required"
                                                name="customer" id="customer" placeholder="Customer"
                                                value="<?php echo $customer; ?>">
                                            <span class="input-group-btn">
                                                <button data-target="#customermodal" id="addNewCustomer"
                                                    class="btn btn-flat btn-primary pull-right" title="New Customer"><i
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" tabindex="5" name="invoicenumber" id="invoicenumber"
                                            class="form-control" />
                                        <input type="hidden" tabindex="6" min="0" step="200" name="additional" value="0"
                                ...
                                <select style="display: none;" tabindex="3" disabled class="form-control" id="location">
                                    ...
                                    <option value="<?php echo $loc->location_id; ?>"
                                        <?php if ($loc->location_id == $_SESSION['location']) {echo 'selected';} ?>>
                        ...
                        <div class="col-md-4">
                            <div class="box-body">
                                <form class="form-horizontal" id="formProduct">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <label for="itemCode" class="col-sm-4 control-label"><span
                                                    class="required"></span></label>
                                            <div class="col-sm-8"><span id="productName"
                                    ...
                                    <div id="productLable">
                                        ...
                                        <div class="form-group" id="dv_FreeQty">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" tabindex="11" min="0" step="1" class="form-control"
                                                    required="required" name="freeqty" id="freeqty"
                                                    placeholder="Enter Qty" value="0" onfocus="this.select();">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="hidden" tabindex="12" min="0" step="1" class="form-control"
                                                    required="required" name="unitcost" id="unitcost"
                                                    placeholder="Enter Qty" value="0" onfocus="this.select();">
                                        ...
                                        <div class="form-group">
                                            <label for="sellingPrice" class="col-sm-4 control-label">Selling Price <span
                                                    class="required">*</span></label>
                                            <div class="col-sm-5">
                                                <input type="number" readonly="readonly" tabindex="13" min="0" step="1"
                                            ...
                                            <div class="col-sm-1"><input class="" type="hidden" name="isZero"
                                                    id="isZero" value='1'></div>
                                        </div>
                                        <div class="form-group" style="display:none;">
                                            <label for="sellingPrice" class="col-sm-4 control-label">VAT Selling Price
                                                <span class="required"></span></label>
                                            <div class="col-sm-5">

                                                <input type="text" class="form-control" required="required"
                                                    name="proVatPrice" id="proVatPrice">
                                            </div>
                                        ...
                                        <input type="hidden" name="totalWithOutDiscount" id="totalWithOutDiscount"
                                            value="0">
                                        <!--                                        <div class="form-group">-->
